...
class Game:
    ...
    def update_score_by_color(self, color, b, score_1, score_2, score_3, score_4):
        ...
        while self.game_loop:
            for event in pygame.event.get():
                ...
                if event.type == pygame.JOYAXISMOTION:
                    ...
                    if event.axis == 0:
                        if event.value > 0.1:
                            if event.joy == 0:
                                self.tank_1.joy_control(1, 0, 0)
                            if event.joy == 1:
                                self.tank_2.joy_control(1, 0, 0)
                            if event.joy == 2:
                                self.tank_3.joy_control(1, 0, 0)
                            if event.joy == 3:
                                self.tank_4.joy_control(1, 0, 0)
                        if event.value < -0.1:
                            if event.joy == 0:
                                self.tank_1.joy_control(-1, 0, 0)
                            if event.joy == 1:
                    ...
                    if event.axis == 1:
                        if event.value < -0.1:
                            if event.joy == 0:
                                self.tank_1.joy_control(0, 1, 1)
                            if event.joy == 1:
                                self.tank_2.joy_control(0, 1, 1)
                            if event.joy == 2:
                                self.tank_3.joy_control(0, 1, 1)
                            if event.joy == 3:
                                self.tank_4.joy_control(0, 1, 1)
            ...
            for b in self.bullets:
                ...
                if b.get_data()[0] == -40:
                    ...
                    self.update_score_by_color(color_1, b, score_1, score_2, score_3, score_4)

                elif response_2:
                    print('color_2', color_2)
                    pygame.mixer.Channel(4).play(self.sound_explosion)
                    self.update_score_by_color(color_2, b, score_1, score_2, score_3, score_4)

                elif response_3:
                    print('color_3', color_3)
                    pygame.mixer.Channel(4).play(self.sound_explosion)
                    self.update_score_by_color(color_3, b, score_1, score_2, score_3, score_4)

                elif response_4:
                    print('color_4', color_4)
                    pygame.mixer.Channel(4).play(self.sound_explosion)
                    self.update_score_by_color(color_4, b, score_1, score_2, score_3, score_4)

                if b.get_count() > touch_limit:
                    self.bullets.remove(b)
